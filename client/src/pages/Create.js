...
class Create extends Component {
  ...
  onSubmit = (e) => {
    ...
    axios
      .post("http://localhost:8000/Store/post", record)
        ...
        <div className="col-8 mx-auto">
          <BannerHolder bannerclass="pageBanner">
            <Banner title="Create An New record page" className="m-3">
              <Link to="/Record" className="btn btn-dark">
                Go to records
              </Link>
            </Banner>
          </BannerHolder>
          <form onSubmit={this.onSubmit} className="mt-4">
            <div className="alert alert-success">
              <h4 className="text-center">
                Create a new Product record,Remember to fill all details
              </h4>
            </div>
            <div className="form-group">
              <label>Enter Product Name: </label>
              <input className="form-control" onChange={this.InputName} />
            </div>
            <div className="form-group">
              <label>Enter Product Price: </label>
              <input className="form-control" onChange={this.InputPrice} />
            </div>
            <div className="form-group">
              <label>Enter Product quantity: </label>
              <input className="form-control" onChange={this.InputQuantity} />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input className="form-control" onChange={this.InputReceivedBy} />
            </div>
